...
/*==========================================================*/
	...
	void module(SymbolTable scope) {
		Expect(4);
		Expect(1);
		Module module = semantic.declareModule(scope, new Identifier(currentToken().spelling())); 
		definitionPart(scope);
		semantic.endModuleDefinitionPart(module); 
		if (la.kind == 5) {
			Get();
	...
	private boolean[][] set = {
		{T,T,x,x, T,x,x,T, x,x,T,x, T,T,x,x, T,T,T,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,T,x, T,T,x,x, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, x,x,x,x, x,x,T,x, T,T,x,x, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, T,T,T,T, x,x,T,x, T,T,x,x, T,T,T,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{T,T,x,x, T,x,x,T, T,x,T,x, T,T,x,x, T,T,T,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,T,T, T,T,T,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,x, T,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, T,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x},
		{x,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,T, T,T,T,x, x,x,x,x, x,x,x,x, x},
		{x,x,x,x, x,x,x,x, x,x,x,T, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, T,T,T,T, x,x,x,x, x},
		{x,T,T,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,T, x,T,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,x,x, x,x,T,x, T,T,T,x, x,x,x,x, x,x,x,x, x}
...
class Errors {
	...
	public void SynErr (int line, int col, int n) {
			...
			case 34: s = "\"llarof\" expected"; break;
			case 35: s = "\"if\" expected"; break;
			case 36: s = "\"fi\" expected"; break;
			case 37: s = "\"do\" expected"; break;
			case 38: s = "\"od\" expected"; break;
			...
			case 67: s = "invalid moreFieldsAndProcedures"; break;
			case 68: s = "invalid parameterDefinition"; break;
			case 69: s = "invalid writeItem"; break;
			case 70: s = "invalid simpleExpr"; break;
			case 71: s = "invalid relationalOperator"; break;
			case 72: s = "invalid addOperator"; break;
			case 73: s = "invalid factor"; break;
			case 74: s = "invalid multiplyOperator"; break;
			case 75: s = "invalid subscriptsAndComponents"; break;
